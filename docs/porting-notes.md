...
| `["RulePlot", prog, nreg]` | `MultiwayRegisterMachineRulePlot` | web rule visualization (explorer phase) | pending | Pure rendering; `splitInstructions` corresponds to `rules_from_instructions`. |
| `["CirclePlot", prog, nreg]` | `MultiwayRegisterMachineCirclePlot` | web rule visualization (explorer phase) | pending | Pure rendering. |
